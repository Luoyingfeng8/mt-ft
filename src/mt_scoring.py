...
def sort_data(src_files, hypo_files, ref_files, lang_pairs):
    ...
    #               'zh2ug':39, 'zh2bo':40, 'ug2zh':41, 'bo2zh':42, 'en2ug':43, 'en2bo':44, 'ug2en':45, 'bo2en':46, 
    #               }
    sort_order = {"en2de":1, "en2ru":2, "en2zh":3, "en2cs":4, 'en2vi': 5, 'en2ko': 6, 'en2ne': 7, 'en2sw': 8, 'en2ha':9,
                  "de2en":10, "ru2en":11, "zh2en":12, "cs2en":13, 'vi2en':14, 'ko2en':15, 'ne2en':16, 'sw2en':17, 'ha2en':18
                  }
